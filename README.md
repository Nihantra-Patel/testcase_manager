...
the SPA page (`www/testcase_manager.html` — the www page stays underscored so
its Python controller is importable; the hyphenated URL is just the route), so
the Vue Router's history-mode
